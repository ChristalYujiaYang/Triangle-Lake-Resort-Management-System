<%@ Page Language="C#" AutoEventWireup="true" CodeFile="关于我们.aspx.cs" Inherits="关于我们" %>
...
<area shape="rect" coords="1063,3,1131,32" href="订单查询.aspx" alt=""/></map>
	...
	<tr>
		<td height="30">
		<li onmouseover="show('nav_1');" onmouseout="hide('nav_1')" ><a href="关于我们.aspx">三角湖度假村</a>
    </li>
		</td>
	</tr>
	<tr>
		<td>
		<li onmouseover="show('nav_3');" onmouseout="hide('nav_3')" ><a href="#">荣誉资质</a>
		</li></td>
	</tr>
	<tr>
		<td>
		<li onmouseover="show('nav_1');" onmouseout="hide('nav_1')" ><a href="#">发展历程</a>
        </li>
		</td>
	</tr>
</table>
    ...
    <td>
        ...
        <asp:Image ID="Image7" runat="server" ImageUrl="~/图片/别墅全景.jpg" Height="179px" 
            Width="305px" />

    </td>
    <td>

        <asp:Image ID="Image8" runat="server" ImageUrl="~/图片/三角湖度假村介绍.jpg" 
            Width="593px" />
