<%@ Page Language="C#" AutoEventWireup="true" CodeFile="餐饮服务.aspx.cs" Inherits="餐饮服务" %>
        ...
        <asp:DataList ID="DataList1" runat="server" GridLines="Horizontal" 
            ...
            <ItemTemplate>
                         <td>
                          ...
                          <td width="2000" align="center">
                          <a href="预订2.aspx?id=<%# DataBinder.Eval(Container.DataItem, "type")%>&pre=<%# DataBinder.Eval(Container.DataItem, "price")%>&duct=<%# DataBinder.Eval(Container.DataItem, "introduction")%>">预订</a>
