<%@ Page Language="C#" AutoEventWireup="true" CodeFile="联系我们.aspx.cs" Inherits="联系我们" %>
...
<area shape="rect" coords="1063,3,1131,32" href="订单查询.aspx" alt=""/></map>
    ...
    <td>
        ...
        <asp:Image ID="Image2" runat="server" ImageUrl="~/图片/联系我们.jpg" />
    ...
    <td>
        <asp:Image ID="Image6" runat="server" ImageUrl="~/图片/联系我们右.jpg" Width="960px" />
    </td>
    </tr>
    <tr>
    <td>
    <table id="5" border="0" cellpadding="0" cellspacing="0" width="380" 
            style="height: 385px; margin-top: 0px">
    <tr align="right">
    <td align="right">
	...
	<tr>
		<td class="style2">
		<li onmouseover="show('nav_1');" onmouseout="hide('nav_1')" ><a href="联系我们.aspx">联系我们</a>
    </li>
		</td>
	</tr>
	<tr>
		<td>
		<li onmouseover="show('nav_2');" onmouseout="hide('nav_2')" ><a href="发送邮件.aspx">发送邮件</a>
        </li>
		</td>
	</tr>
</table>
    ...
    <td>
        ...
        <asp:Image ID="Image7" runat="server" ImageUrl="~/图片/联系我们内部.jpg" />
