...
<area shape="rect" coords="1063,3,1131,32" href="订单查询.aspx" alt=""/></map>
    ...
    <tr>
    <td>
        <asp:Image ID="Image5" runat="server" ImageUrl="~/图片/会员登录左.jpg" />
    </td>
    <td>
        <asp:Image ID="Image6" runat="server" ImageUrl="~/图片/会员登录右.jpg" Width="962px" />
    </td>
    </tr>
    <tr>
    <td>
    ...
    <td align="center" style="font-size: small">
        身份证号：<asp:TextBox ID="user_TextBox" runat="server"></asp:TextBox>
        <br />
        密码：&nbsp;&nbsp;&nbsp; 
        <asp:TextBox ID="password_TextBox" runat="server" TextMode="Password"></asp:TextBox>
        <br />
        验证码：&nbsp; <asp:TextBox ID="txtValidatedcode" runat="server"></asp:TextBox>
        <br />
        <asp:Button ID="btnLogin" runat="server" Text="登录" onclick="btnLogin_Click" />
        </td>
        <td><asp:Image ID="vcmg" runat="server" Height="20px" ImageUrl="~/ValidateCode.aspx" /></td>
        <td><a href="javascript:change();" style="font-size: small">看不清，换一张</a></td>
    </tr>
    </table>
    </td>
    </tr>
