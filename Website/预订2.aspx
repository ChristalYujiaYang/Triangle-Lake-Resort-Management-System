<%@ Page Language="C#" AutoEventWireup="true" CodeFile="预订2.aspx.cs" Inherits="预订2" %>
...
<area shape="rect" coords="1063,3,1131,32" href="订单查询.aspx" alt=""/></map>
    ...
    <tr>
    <td style="font-family: 宋体, Arial, Helvetica, sans-serif; font-weight: bold; color: #000000; font-size: small;">
        预订份数：<asp:DropDownList ID="DropDownList4" runat="server">
    ...
    <table><tr><td>用餐日期：
        <asp:Calendar ID="Calendar1" runat="server" 
            onselectionchanged="Calendar1_SelectionChanged" Width="234px"></asp:Calendar>
    </td>
    <td width="40px">
        &nbsp;</td>
    <td>
        <asp:Label ID="Label1" runat="server" Text="日期超出可选范围" ForeColor="Red"></asp:Label></td>
    </tr></table>
    </td>
    </tr>
    </table>
    ...
    餐饮地点：&nbsp;
        ...
        <asp:DropDownList ID="DropDownList2" runat="server">
            ...
            <asp:ListItem>度假村餐厅</asp:ListItem>
        </asp:DropDownList>
